...
function homePage(data) {
  ...
  return layout(data, { title: "Minoxidil en CDMX", path: "/", description: data.description, image: hero, headerMode: "overlay", bodyClass: "home-page", body });
}
...
function contactPage(data, route = "/contact/") {
  ...
  return layout(data, { title: "Sucursal y Contacto", path: route, description: "Sucursal en CDMX, oficinas en Neza y WhatsApp para comprar minoxidil y tratamientos capilares.", image: hero, headerMode: "overlay", bodyClass: "contact-page", body });
}
